...
Keep only storms having USA_WIND >= 34 (or >= 55) occurring between 1981 and 2022
```{r}
Tracks.sf <- Tracks.sf |>
  filter(year >= 1981 & year <= 2022) |>
  filter(USA_WIND >= 55) |> # tropical storms and hurricanes
...
1985 1987 1988 1990 1992 1994 1995 1996 1997 1998 1999 2000 2001 
   4    1    1    1    1    2    3    1    1    3    1    1    2 
2004 2005 2006 2008 2012 2013 2016 2017 2018 2020 2021 2022 
   4    5    1    1    1    1    1    1    1    3    2    2 
...
all_dates <- as.IDate(seq(as.Date("1985-01-01"), as.Date("2022-12-31"), by = "day"))
...
Files received from Jihoon on November 27, 2025. We run these files sequentially, merging with storms and fitting models separately for each subset. Use 1985-01-01 for 55+ storms
```{r}
...
Filter deaths by date of death and storm effect zones. It took 2.42 hours on my Apple M4 using all deaths (1981-2022)
```{r}
start_time <- Sys.time()
...
st_drop_geometry(deaths_all_effects) %>%
  readr::write_csv("data/outputs/Deaths/All_Deaths_Storm_Effects_55+.csv")
```
...
st_write(
  ...
  dsn = "data/outputs/Deaths/All_Deaths_Storm_Effects_55+.gpkg",
