...
This takes too long (~ 85 hours, 3.5 days) and the following warnings:
...
Try a two-part “threshold (≤6) + truncated count (>6)” approximation (stays in `fixest`). The process is modeled as:
