...
Filter storms by third trimester date range. Test on a sample of 5000 births
```{r}
keep_rows <- sample.int(nrow(BirthsWithin.sf), size = 5000)
...
X <- births_with_impacts |> 
  dplyr::summarise(n = dplyr::n(),
                   .by = c(Birth_ID, Birth_Date, DateT3s, geometry, NAME)) |>
  dplyr::filter(n >= 1)
