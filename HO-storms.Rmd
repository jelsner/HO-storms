...
```{r}
start_time <- Sys.time()
combined_data_wide_ordered.dt <- combined_data_wide.dt[order(match(combined_data_wide.dt$ID, All.dt$ID))]

All_1st_Trimester_Storm_Effects.dt <- cbind(All.dt, combined_data_wide_ordered.dt)
Sys.time() - start_time
```
...
# read it back
All_1st_Trimester_Storm_Effects.dt <- data.table::fread(file = "data/outputs/All_1st_Trimester_Storm_Effects.csv")
```
