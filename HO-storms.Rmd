...
## Summary of the procedures used in TC modeling and merging of birth records
...
# Rename geometry colum. Can't have matching names when merging w/ birth/death records
sf::st_geometry(TIC.sf) <- "geom"
