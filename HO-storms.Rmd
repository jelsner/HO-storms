...
The situations are different for Erin, Irma, and Ian so it is not clear what to do. The first way is simple to remove these storms from further consideration
```{r}
