...
# --- Build the figure ---
fig3 <- plot_prepost_rr(res_days, res_main, log_y = FALSE, show_title = TRUE)
print(fig3)

#ggsave("figs/Figure3_prepost_rr.pdf", fig3, width = 5, height = 5, units = "in")
ggsave("figs/Figure3_prepost_rr.png",  fig3, width = 5, height = 5, units = "in", dpi = 600)
```
