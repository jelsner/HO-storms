...
# If you cannot add packages, see the cowplot alternative further below.

# ---- Theme tuned for publication (keeps your system's default font family) ----
...
# ---- Combine into a single figure (top: A, bottom: B) ----
# heights controls relative vertical space; adjust if needed
fig3 <- panel_A / panel_B + plot_layout(heights = c(1, 1)) &
  theme_pub(10)

ggsave("figs/Figure2_profile_pre_post_rr.png",  fig3, width = 4, height = 5, units = "in", dpi = 600)

# Optional global annotation (e.g., figure caption)
```
