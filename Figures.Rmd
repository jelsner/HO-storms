...
res_pre <- res_pre |>
  mutate(group = factor(group, levels = c("≥64 kt", "≥55 kt", "≥34 kt")))
...
ggsave("figs/FigureA_placebo_pre_rr_64kt.png", FigA, width = 5.5, height = 4.0, units = "in", dpi = 600)
# ggsave("placebo_pre_rr_64kt.pdf",  FigA, width = 5.5, height = 4.0, units = "in")
```
