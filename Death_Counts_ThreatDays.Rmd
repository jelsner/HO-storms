...
rel_day_f
    None       -8       -7       -6       -5       -4 
14445031     4259     4259     4259     4259     4259 
      -3       -2       -1        0        1        2 
    4259     4259     4259     4259     4259     4259 
       3        4        5        6        7        8 
    4259     4259     4259     4259     4259     4259 
...
Save
```{r}
saveRDS(deaths_with_zip, "data/outputs/Results/deaths_with_zip_55kt_PLACEBO.rds")
...
Export (optional)
```{r}
readr::write_csv(panel, "data/outputs/Deaths/daily_panel_55kt_PLACEBO.csv")
...
# Event-time model with ZIP-specific COVID shift **as a fixed effect**:
m_event <- fepois(
  deaths ~ i(rel_day_f, ref = "None") | zip + ym + dow + zip_covid,
  data    = dat,
  cluster = ~ zip + ym,
  notes   = FALSE
)
...
dat <- dat %>%
  mutate(yw = interaction(lubridate::year(as.Date(date)),
